          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-6 bg-white shadow-md hover:shadow-lg hover:bg-emerald-50 transition duration-300 cursor-pointer">
              ...
              <p className="text-gray-600 mt-3 text-lg">
                Explore a wide range of majors and minors with full scholarship
                opportunities, tailored to your academic and career goals.
              </p>
            ...
            <div className="p-6 bg-white shadow-md hover:shadow-lg hover:bg-emerald-50 transition duration-300 cursor-pointer">
              <h4 className="text-3xl  text-emerald-600">Graduate Programs</h4>
              <p className="text-gray-600 mt-3 text-lg">
            ...
            <div className="p-6 bg-white shadow-md hover:shadow-lg hover:bg-emerald-50 transition duration-300 cursor-pointer">
              ...
              <p className="text-gray-600 mt-3 text-lg">
                Enhance your credentials with specialized certifications, backed
                by scholarship support for career growth.
              </p>
              <div className="relative mt-4 overflow-hidden shadow-md">
                <LazyLoadImage
                  src="/p3.jpg"
